	...
	<div id="cart" class="cart_section">
		<div class="container-fluid">
            ...
            session_start();
              ...
              if ($hitung < 1){
                echo"<script>window.alert('Wishlist kosong....');
                ...
                while($bacaku=mysql_fetch_array($sql)){
                  ...
                  */
                  ...
                  echo"
							...
							<tbody>
								<tr>
                <input type=hidden name=id[$no] value=$bacaku[id_wish]>
									<td><a class='table-cart-figure'><img width=100 src=admin/foto/$bacaku[feature_image]></a><a class='table-cart-link'>$bacaku[product_name]</a></td>
									<td>Rp. $hargadisc</td>
									<td>
                  <a class='btn' href='detail.php?id=$bacaku[id]'><i class='fa fa-shopping-cart'></i> BUY</a><br>
									</td>
                  <td>
                  <a style='color:red;' href=input2.php?input=delete&id=$bacaku[id_wish]><i class='fa fa-remove'></i></a>
                  </td>
