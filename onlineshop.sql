...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 14, 2019 at 03:09 AM
...
INSERT INTO `keranjang` (`id_keranjang`, `id_product`, `id_session`, `tgl_keranjang`, `qty_s`, `qty_m`, `qty_l`, `qty_xl`) VALUES
(438, 52, '20eoh9uaq41p3nn912s41j2lv6', '2019-11-14', 0, 0, 0, 0);
...
CREATE TABLE `wish` (
  `id_wish` int(5) NOT NULL,
  `id_product` int(5) NOT NULL,
  `id_session` varchar(100) COLLATE latin1_general_ci NOT NULL,
  `tgl_wish` date NOT NULL,
  `qty_s` int(10) NOT NULL,
  `qty_m` int(10) NOT NULL,
  `qty_l` int(10) NOT NULL,
  `qty_xl` int(10) NOT NULL
...
INSERT INTO `wish` (`id_wish`, `id_product`, `id_session`, `tgl_wish`, `qty_s`, `qty_m`, `qty_l`, `qty_xl`) VALUES
(479, 52, '20eoh9uaq41p3nn912s41j2lv6', '2019-11-14', 0, 0, 0, 0);
...
(1, 'Toko Baju', 'www.baju.com', 'jual baju, jal kaos', 'merupakan sebuah online store terbesar se indonesia', 'admin', 'admin@gmail.com', '5', 32523523523, '75464645', 'xxx', 'admin', 'admin', 'xxxx', 'xxxx', 'xxxx');
...
(2, 'admin2', 'admin2', 'e10adc3949ba59abbe56e057f20f883e', 'admin2@gmail.com', 'admin');
...
--
ALTER TABLE `keranjang`
  MODIFY `id_keranjang` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=439;

--
-- AUTO_INCREMENT for table `wish`
--
ALTER TABLE `wish`
  MODIFY `id_wish` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=480;
