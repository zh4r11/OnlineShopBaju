...
<html lang="en">
<head>
	<title>Fashion Shop | products page</title>
	<meta charset="utf-8">
						...
						<nav class="navbar navbar-expand-md navbar-light">
							...
							<div class="collapse navbar-collapse mean-menu" style="display: block;">
								<ul class="navbar-nav">
									...
									<li class="nav-item"><a href="#" class="nav-link">Shop<i class="fa fa-angle-down"></i></a>
										<ul class="dropdown-menu">
						...
						<div class="single_products_images">
							<div class="single_product_image">
								<div class="sp-loading">
									<img src="assets/image/products/product-1.jpg" alt="" width="100%">
								</div>
								...
								<div class="col-sm-12">
									<div class="product-thumb">
										<div class="image wow fadeInDown animated">
											<a href=""><img class="wow fadeInDown animated" src="assets/image/products/product-2.jpg" alt="Kundli Dosha" title="Kundli Dosha" width="100%"></a>
