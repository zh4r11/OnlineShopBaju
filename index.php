...
<!-- silder End -->
<!-- about Us -->
  <div id="about_us" class="about_section" style="background-image: url(dex/assets/image/about_img.jpg);width: 100%;background-repeat: no-repeat; background-size: cover;">
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-6">
                ...
                <div class="col-md-6 col-xs-6">
                  <div class="form-group input-group input-group-sm wow fadeInDown pull-right">
                    ...
                    <div class="select-wrapper">
                      <select id="sortby" name="sortby" class="form-control" onchange="location = this.value;">
                        <option value="" selected="selected">Default</option>
                         <option id="sortby" value="pagebaru1.php">Terbaru</option>
                        <option id="sortby" value="pagebaru2.php">Termurah</option>
                         <option id="sortby" value="pagebaru.php">Termahal</option>
