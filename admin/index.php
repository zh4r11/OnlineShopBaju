			...
			<div class="row billing_and_payment_option wow fadeInDown   animated">
				...
				<div class="login_box">
					<h3>Login Your Account</h3>
						<form  class="form-1" method="post" action="login.php" enctype="multipart/form-data" class="eb-form eb-mailform form-checkout" novalidate="novalidate">
							<div class="form-wrap">
								<input id="login-username" class="form-input form-control" type="text" name="username" value="" placeholder="Username"><br>
							</div>
							<div class="form-wrap">
								<input class="form-input form-control" type="password"name="pass" placeholder="password">
							</div>
