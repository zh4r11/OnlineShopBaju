...
<div id="footer">
  <div class="container">
    <p class="footer-class">Copyright &copy; <?php echo date('Y') ?> | All Rights Reserved | Repost by <a href="https://stokcoding.com/" title="StokCoding.com" target="_blank">StokCoding.com</a></p>
  </div>
</div>
</div>
